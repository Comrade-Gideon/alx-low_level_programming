...
- [While loop](https://youtu.be/Ju1LYO9pkaI?si=M4EF3X59u_bdLpLb)

### man or help:
- `ascii` *(You do not need to learn about `scanf`, `getc`, `getchar`, `EOF`, `EXIT_SUCCESS`, `time`, `rand`, `srand`, `RAND_MAX`, for loops, do...while loops, functions.)*

### Additional resources:
- [Introduction to C (Basic structure and variables)](https://youtu.be/LM6IjCbtpZA?si=EIwvQOTEM2LZPaD7)
